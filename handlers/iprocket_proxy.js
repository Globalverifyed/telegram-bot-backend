...
const iprocketDiscountPackages = [
  { name: "2 GB", price: "$2.50 USDT", callback: "iprocket_discount_2gb" },
  { name: "4 GB", price: "$5.00 USDT", callback: "iprocket_discount_4gb" },
  { name: "6 GB", price: "$7.50 USDT", callback: "iprocket_discount_6gb" },
  { name: "8 GB", price: "$10.00 USDT", callback: "iprocket_discount_8gb" },
  { name: "10 GB", price: "$12.50 USDT", callback: "iprocket_discount_10gb" }
];

const iprocketRegularPackages = [
  { name: "2 GB", price: "$3.00", callback: "iprocket_regular_2gb" },
  { name: "4 GB", price: "$6.00", callback: "iprocket_regular_4gb" },
  { name: "6 GB", price: "$9.00", callback: "iprocket_regular_6gb" },
  { name: "8 GB", price: "$12.00", callback: "iprocket_regular_8gb" },
  { name: "10 GB", price: "$15.00", callback: "iprocket_regular_10gb" },
  { name: "16 GB", price: "$24.00", callback: "iprocket_regular_16gb" },
  { name: "20 GB", price: "$30.00", callback: "iprocket_regular_20gb" },
  { name: "30 GB", price: "$45.00", callback: "iprocket_regular_30gb" }
];
