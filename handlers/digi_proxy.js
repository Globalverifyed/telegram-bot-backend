...
const digiDiscountPackages = [
  { name: "1 GB", price: "$1.5 USDT", callback: "digi_discount_1gb" },
  { name: "2 GB", price: "$3 USDT", callback: "digi_discount_2gb" },
  { name: "3 GB", price: "$4.5 USDT", callback: "digi_discount_3gb" },
  { name: "4 GB", price: "$6 USDT", callback: "digi_discount_4gb" },
  { name: "5 GB", price: "$7.5 USDT", callback: "digi_discount_5gb" }
];

const digiRegularPackages = [
  { name: "1 GB", price: "$1.10", callback: "digi_regular_1gb" },
  { name: "2 GB", price: "$2.20", callback: "digi_regular_2gb" },
  { name: "3 GB", price: "$3.30", callback: "digi_regular_3gb" },
  { name: "4 GB", price: "$4.40", callback: "digi_regular_4gb" },
  { name: "5 GB", price: "$5.50", callback: "digi_regular_5gb" },
  { name: "10 GB", price: "$10.50", callback: "digi_regular_10gb" },
  { name: "15 GB", price: "$16.50", callback: "digi_regular_15gb" },
  { name: "20 GB", price: "$21.00", callback: "digi_regular_20gb" }
];
