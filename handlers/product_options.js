...
abc_discount_10gb: { productKey: "abc_proxy", itemKey: "abc_d_10", name: "ABC Proxy", package: "10GB Discount", price: "$10.50 USDT", back: "abc_discount_menu" },
  ...
  // NOV PROXY
  // =========================
  nov_proxy_discount_1gb: { productKey: "nov_proxy", itemKey: "nv_d_25", name: "Nov Proxy", package: "25 IP Discount", price: "$2.00", back: "nov_proxy_discount_menu" },
  nov_proxy_discount_2gb: { productKey: "nov_proxy", itemKey: "nv_d_50", name: "Nov Proxy", package: "50 IP Discount", price: "$4.00", back: "nov_proxy_discount_menu" },
  nov_proxy_discount_3gb: { productKey: "nov_proxy", itemKey: "nv_d_100", name: "Nov Proxy", package: "100 IP Discount", price: "$8.00", back: "nov_proxy_discount_menu" },
  nov_proxy_discount_4gb: { productKey: "nov_proxy", itemKey: "nv_d_200", name: "Nov Proxy", package: "200 IP Discount", price: "$16.00", back: "nov_proxy_discount_menu" },
  nov_proxy_discount_5gb: { productKey: "nov_proxy", itemKey: "nv_d_400", name: "Nov Proxy", package: "400 IP Discount", price: "$32.00", back: "nov_proxy_discount_menu" },

  nov_proxy_regular_1gb: { productKey: "nov_proxy", itemKey: "nv_r_25", name: "Nov Proxy", package: "25 IP Regular", price: "$3.00", back: "nov_proxy_regular_menu" },
  nov_proxy_regular_2gb: { productKey: "nov_proxy", itemKey: "nv_r_50", name: "Nov Proxy", package: "50 IP Regular", price: "$6.00", back: "nov_proxy_regular_menu" },
  nov_proxy_regular_3gb: { productKey: "nov_proxy", itemKey: "nv_r_100", name: "Nov Proxy", package: "100 IP Regular", price: "$12.00", back: "nov_proxy_regular_menu" },
  nov_proxy_regular_4gb: { productKey: "nov_proxy", itemKey: "nv_r_200", name: "Nov Proxy", package: "200 IP Regular", price: "$22.00", back: "nov_proxy_regular_menu" },
  nov_proxy_regular_5gb: { productKey: "nov_proxy", itemKey: "nv_r_400", name: "Nov Proxy", package: "400 IP Regular", price: "$42.00", back: "nov_proxy_regular_menu" },
  nov_proxy_regular_10gb: { productKey: "nov_proxy", itemKey: "nv_r_800", name: "Nov Proxy", package: "800 IP Regular", price: "$78.00", back: "nov_proxy_regular_menu" },
  nov_proxy_regular_15gb: { productKey: "nov_proxy", itemKey: "nv_r_1000", name: "Nov Proxy", package: "1000 IP Regular", price: "$88.00", back: "nov_proxy_regular_menu" },
  nov_proxy_regular_20gb: { productKey: "nov_proxy", itemKey: "nv_r_1200", name: "Nov Proxy", package: "1200 IP Regular", price: "$99.00", back: "nov_proxy_regular_menu" },
